    ...
    <main class="section bg-light">
        <div class="container">
            <div class="mb-4 d-flex justify-content-between align-items-center">
                ...
                <a href="<?= Controller::path() ?>admin/crear" class="btn btn-success">+ Nuevo Usuario</a>
            </div>

            <form method="get" action="<?= Controller::path() ?>admin/buscar" class="d-flex gap-2 mb-4">
            ...
            <div class="d-flex justify-content-between">
                <a href="<?= Controller::path() ?>logout/logout" class="btn btn-logout border border-danger text-danger mt-4">Cerrar sesión</a>
            ...
            <div class="text-center mt-5 d-flex align-items-center justify-content-center">
                <a href="<?= Controller::path() ?>" class="text-regular text-primary text-x-medium volver"><< Volver al Inicio</a>
            </div>
