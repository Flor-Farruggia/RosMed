...
<main class="bg-light py-5">
    <div class="container">
        ...
        <form action="<?= $path ?>medico/subirArchivo" method="post" enctype="multipart/form-data" class="mb-4">
                    ...
                    <?php foreach ($archivos as $archivo): ?>
                        <tr>
                            ...
                            <td class="text-center text-regular p-2">
                                <a href="<?= $path ?>medico/descargarArchivo/<?= $archivo['id'] ?>" class="btn  btn-primary" target="_blank">Descargar</a>
                                <a href="#" class="btn btn-danger btn-eliminar" data-url="<?= $path ?>medico/eliminarArchivo/<?= $archivo['id'] ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <a href="/RosMed/medico" class="btn btn-secondary mt-3">Volver</a>
    </div>
